...
public static class KafkaTopicEndPointExtensions
{
    ...
    private const string Method = "ActionMethod";
    ...
    private static void GetTopicEndpointConfiguration(IRiderRegistrationContext riderRegistrationContext, Type assembly,
